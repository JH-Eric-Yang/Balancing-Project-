...
if __name__ == "__main__":
    ...
    for subdir in subdirs:
        ...
        merge_video_and_names(input_directory,type="estimation") #normal or estimation, if you want to only merget the collected data, use normal, if you want to merge the collected and estimation data, use estimation
